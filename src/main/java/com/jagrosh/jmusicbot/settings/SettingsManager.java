...
public class SettingsManager implements GuildSettingsManager<Settings>
{
    ...
    public SettingsManager()
    {
        ...
        try {
            ...
            try {
                LoggerFactory.getLogger("Settings").info("serversettings.json will be created in " + OtherUtil.getPath(SETTINGS_FILE).toAbsolutePath());
                Files.write(OtherUtil.getPath(SETTINGS_FILE), new JSONObject().toString(4).getBytes());
        ...
        LoggerFactory.getLogger("Settings").info("serversettings.json loaded from " + OtherUtil.getPath(SETTINGS_FILE).toAbsolutePath());
    }

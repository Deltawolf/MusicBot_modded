...
public class ScientistMode extends MusicCommand {

	Bot localBot;

	public ScientistMode(Bot bot)
    {
		super(bot);

		localBot = bot;
        this.name = "scientistmode";
	...
	public void doCommand(CommandEvent event) {
			...
			if (listener instanceof CommandClientImpl) {
				...
				for (Object command : commands) {
					...
					if(command instanceof PlayCmd) {
						((PlayCmd)command).setScientistMode();
					}
		...
		event.reply("I'm somewhat of a scientists myself.");
